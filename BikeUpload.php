...
if ($_SERVER['REQUEST_METHOD'] == 'POST' || $_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if ($bike_id !== null && $time !== null && $speed !== null && $voltage !== null && $current !== null && $power !== null) {

        // Construct the SQL insert statement

        $stmt = $conn->prepare("INSERT INTO `data` (`bike_id`, `time`, `speed`, `voltage`, `current`, `power`) VALUES (?, ?, ?, ?, ?, ?)");
        ...
        if (!$stmt->bind_param("isdddd", $bike_id, $time, $speed, $voltage, $current, $power)) {
